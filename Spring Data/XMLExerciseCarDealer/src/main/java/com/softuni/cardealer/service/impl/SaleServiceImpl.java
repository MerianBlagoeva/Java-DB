...
import com.softuni.cardealer.model.dto.ex6.SaleInfoDto;
import com.softuni.cardealer.model.dto.ex6.SaleInfoRootDto;
import com.softuni.cardealer.model.dto.seed.SaleSeedDto;
...
public class SaleServiceImpl implements SaleService {
    ...
    public void seedSales() {
        ...
        List<Double> discountList = List.of(0.0, 0.5, 0.1, 0.15, 0.2, 0.3, 0.4, 0.5);
    ...
    @Override
    public SaleInfoRootDto findAllSales() {

        SaleInfoRootDto saleInfoRootDto = new SaleInfoRootDto();

        saleInfoRootDto.setSales(saleRepository
                .findAll()
                .stream()
                .map(sale -> {
